                ...
                <div className="language-dropdown relative flex-grow">
                  ...
                  {dropdownOpen && (
                    <motion.div
                      ...
                      className="absolute bottom-full left-2 mb-6 w-full bg-white p-1 rounded-lg border border-gray-200 z-[9999] language-dropdown"
                      style={{
        ...
        <div className="flex justify-around items-center">
          ...
          <button
            className={`flex flex-col items-center justify-center p-2 rounded-lg transition-all duration-200 ${
              isActive === "admin" ? "bg-primary-purple" : "hover:bg-gray-100"
            }`}
            onClick={() => {
              handleActive("admin");
              router.push("/admin");
          ...
          >
            <GoHomeFill className={`w-6 h-6 ${isActive === "admin" ? "text-white" : "text-gray-600"}`} />
          </button>

          {/* Users */}
          <button
            className={`flex flex-col items-center justify-center p-2 rounded-lg transition-all duration-200 ${
              isActive === "admin/user" ? "bg-primary-purple" : "hover:bg-gray-100"
            }`}
            onClick={() => {
              handleActive("admin/user");
              router.push("/admin/user");
          ...
          >
            <FaUser className={`w-5 h-5 ${isActive === "admin/user" ? "text-white" : "text-gray-600"}`} />
          </button>

          {/* Reports */}
          <button
            className={`flex flex-col items-center justify-center p-2 rounded-lg transition-all duration-200 ${
              isActive === "admin/report" ? "bg-primary-purple" : "hover:bg-gray-100"
            }`}
            onClick={() => {
              handleActive("admin/report");
              router.push("/admin/report");
          ...
          >
            <MdReport className={`w-6 h-6 ${isActive === "admin/report" ? "text-white" : "text-gray-600"}`} />
          </button>
          ...
          <div className="language-dropdown relative">
            ...
            {dropdownOpen && (
              <motion.div
                ...
                exit={{ opacity: 0, y: 10, scale: 0.95 }}
                transition={{ duration: 0.15, ease: "easeOut" }}
                className="absolute bottom-full left-0 transform -translate-x-1/2 mb-5 w-40 bg-white shadow-xl p-1 rounded-lg border border-gray-200 z-[9999] language-dropdown"
                style={{
                  boxShadow: "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)",
                }}
                onClick={(e) => {
