                ...
                <div className="max-w-7xl mx-auto">
                    <div className="bg-white/80 backdrop-blur-sm border border-red-200 rounded-2xl p-8 shadow-2xl">
                        <div className="flex items-center">
                            ...
                            <div className="ml-6">
                                <LabelShadcn text="admin:error.error-loading-data" translate className="text-xl font-bold text-red-800 mb-2" />
        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="mb-12 text-center">
                    ...
                    <LabelShadcn text="admin:admin.dashboard-admin-description" translate className="text-3xl font-bold bg-gradient-to-r from-gray-800 via-purple-800 to-pink-800 bg-clip-text text-transparent mb-4" />
                </div>
                ...
                <div className="bg-white/70 backdrop-blur-sm rounded-xl shadow-lg p-4 mb-8 border border-white/30">
                    <div className="flex items-center justify-between flex-wrap gap-4">
                        ...
                        <div className="flex items-center gap-3 flex-wrap">
                            <div className="flex items-center gap-2">
                                <LabelShadcn text="common:filter.from" translate className="text-xs font-medium text-gray-600 min-w-0" />
                                <input
                                    type="date"
                            ...
                            <div className="flex items-center gap-2">
                                <LabelShadcn text="common:filter.period" translate className="text-xs font-medium text-gray-600 min-w-0" />
                                <select
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                    <LineChart
                        ...
                        title="admin:title-chart.user-registrations"
                        color="bg-blue-500"
                    />
                    <LineChart
                        data={postsCreation}
                        title="admin:title-chart.posts-creation"
                        color="bg-purple-500"
                    />
                </div>
                ...
                <div className="mb-12">
                    <LineChart
                        data={reportsData}
                        title="admin:title-chart.reports-data"
                        color="bg-amber-500"
                    />
                </div>
                ...
                <div className="text-center">
                    <div className="inline-flex items-center px-6 py-3 bg-white/80 backdrop-blur-sm rounded-full shadow-lg border border-white/20">
                        ...
                        <LabelShadcn text={`admin:footer.last-updated ${new Date().toLocaleString("vi-VN")}`} translate className="text-sm text-gray-600 font-medium" splitAndTranslate />
                    </div>
                </div>
            </div>
        </div>
